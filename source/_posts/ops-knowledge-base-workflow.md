---
title: "运维个人知识库助手（Dify 工作流）使用说明"
date: 2026-07-29 10:37:12
description: "运维个人知识库助手（Dify 工作流）使用说明——从核心原理到实际操作的完整技术笔记。"
categories:
  - 效率工具
tags:
  - Dify
...
| 知识库建议名 | 建议上传的本地文档 |
|--------------|-------------------|
| 运维核心 | `ansible-usage-guide.md`、`ansible-README.md`、`ufw-usage-guide.md`、`domain-name-guide.md`、`tcpdump-guide.md` |
| 平台工程 | `gitlab-docker-compose-guide.md`、`GitLab *.md`、`Helm-3-*.md`、`Istio*.md`、`数据库技术文档*.md`、`GitLab CICD*.md` |
